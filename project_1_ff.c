...
#include"data_ff.h"
#include"memory_ff.h"
#include"project_1_ff.h"//invokes user defined header file named project_1
...
void project_1_report()
{
 ...
 printf("The entire 32 byte array is: \n");
 while(length--)
  {
    printf("%d\t",*aptr_1);
    aptr_1++;
...
//1. testing memory functions
 ...
 printf("%s",arr2);
    ...
    // MEMZERO TESTING
 my_memzero(arr2,12);
 printf("MEMZERO:  after memzero,value is:");
 for(k=0;k<12;k++)
  {
    printf("%d",arr2[k]);
  }
